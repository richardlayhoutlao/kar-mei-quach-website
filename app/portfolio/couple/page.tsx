  ...
  return (
    <>
      ...
      <section className="relative flex h-[80vh] min-h-[520px] md:h-[80vh] w-full overflow-hidden">
        ...
        <div className="hidden md:block absolute inset-y-0 left-0 w-1/2 dark:bg-background [background:radial-gradient(ellipse_70%_80%_at_50%_50%,#e8e4f4_0%,transparent_100%)] dark:[background:none]" />
